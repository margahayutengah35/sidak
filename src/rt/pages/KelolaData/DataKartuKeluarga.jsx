// src/rt/pages/KelolaData/DataKartuKeluarga.jsx
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const rt = localStorage.getItem("userRt");
        const rw = localStorage.getItem("userRw");
        ...
        if (noKK) query = query.eq("no_kk", noKK);
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow relative">
      ...
      <TableComponent
        ...
        loading={loading} // kirim prop loading
      />

      {/* Tabel KK tanpa Kepala Keluarga */}
      <h2 className="text-md font-bold mt-6 mb-2 text-red-600">
    ...
    <div className="mb-10">
                ...
                <tr key={item.id_penduduk} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 border">
                    <div className="flex justify-center items-center space-x-4">
                      <Link
                        to={`/rt/keloladata/detailanggotakk/${item.no_kk}`}
      ...
      <div className="flex justify-between items-center mt-4">
        <span className="text-sm">
          Showing {data.length === 0 ? 0 : indexOfFirst + 1} to{" "}
          {Math.min(indexOfLast, data.length)} of {data.length} entries
        </span>
